...
const TIERS = [
  { key: 'mega', label: 'ဝေလငါး အကြီးဆုံး', icon: '🐋', min: 100000 },
  { key: 'whale', label: 'ဝေလငါး', icon: '🐳', min: 10000 },
  { key: 'dolphin', label: 'ဒေါ်လဖင်', icon: '🐬', min: 1000 },
  { key: 'fish', label: 'ငါး', icon: '🐟', min: 100 },
  { key: 'shrimp', label: 'ပုစွန်', icon: '🦐', min: 0 }
];
