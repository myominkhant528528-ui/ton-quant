...
{#if !model}
  <div class="empty">Holder ဒေတာပါသော token များ မလုံလောက်ပါ။</div>
{:else}
  <div class="wrap">
    <table class="ph">
      <thead><tr><th></th><th class="r">mcap</th><th class="r">Holder များ</th><th class="r">$/Holder</th><th class="r">အလယ်တန်းနှင့် နှိုင်း</th></tr></thead>
      <tbody>
        {#each model.rows as r}
          <tr>
            <th class="rh">{r.sym}</th>
            <td class="r m">{fmtUsd(r.mcap)}</td>
            <td class="r m">{r.holders.toLocaleString('en-US')}</td>
  ...
  <div class="note">$/Holder = holder တစ်ဦးလျှင် mcap။ အစုအဝေး၏ အလယ်တန်းတန်ဖိုး: <strong>{fmtUsd(model.med)}</strong>။ အလယ်တန်းထက် အလွန်မြင့်ခြင်း = wallet အနည်းငယ်ကသာ market cap ကို ထိန်းထားခြင်း (ဖောင်းပွနေခြင်း သို့မဟုတ် စုစည်းနေခြင်း)၊ အလွန်နိမ့်ခြင်း = လူအများအပြားထံ ပြန့်ကျဲနေခြင်း။ ၎င်းသည် တန်ဖိုးကြီးလွန်းမှုကို အပြန်အလှန်စစ်ထုတ်ခြင်းသာဖြစ်ပြီး ဆုံးဖြတ်ချက်ကို သင့်ဘာသာ ချမှတ်ပါ။</div>
{/if}
