...
{:else}
  <div class="wrap">
    <table class="mom">
      <thead><tr><th></th><th>7 ရက်</th><th>14 ရက်</th><th>30 ရက်</th><th class="rs">RS</th><th>လမ်းကြောင်း</th></tr></thead>
      <tbody>
        {#each model as x, i}
          <tr>
  ...
  <div class="note">RS = 7/14/30 ရက် ပျမ်းမျှ percentile။ လမ်းကြောင်း = လွန်ခဲ့သော တစ်ပတ်နှင့် နှိုင်းယှဉ်ထားသော RS ပြောင်းလဲမှု။ token {model.length} ခု။</div>
{/if}
