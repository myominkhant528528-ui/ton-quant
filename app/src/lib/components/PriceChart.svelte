...
<div class="wrap" onpointermove={onMove} onpointerleave={() => (hover = null)}>
  <svg viewBox="0 0 {W} {H}" preserveAspectRatio="none" class="pc" role="img" aria-label="ဈေးနှုန်းနှင့် ပျမ်းမျှကုန်ကျစရိတ် နှိုင်းယှဉ်ချက်">
...
<div class="cap muted">─ ဈေးနှုန်း · ┄ ပျမ်းမျှကုန်ကျစရိတ် {fmt(avg)} (ခန့်မှန်း)</div>
